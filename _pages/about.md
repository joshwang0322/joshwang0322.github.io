...
- We can propose a unified rare-event simulation algorithm that is not only strongly efficient but also universarlly applicable to a wide range of contexts, including mathematical finances, stochastic optimization, and queuing networks (see [[3]](https://joshwang0322.github.io//WangRhee23b.pdf)); this algorithm remains effective even in particularly challenging scenarios where it is computationally infeasible to simulate or store the underlying process (see [[4]](https://informs-sim.org/wsc20papers/034.pdf)). 
